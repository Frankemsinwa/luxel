    ...
    if (isFetching) {
        return (
            <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-zinc-400 font-bold uppercase tracking-widest text-[10px]">Recalibrating Experience Engine...</p>
            </div>
        );
    }
        ...
        <div className="max-w-5xl mx-auto space-y-6 lg:space-y-10 pb-20">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between sticky top-0 bg-[#F8F9FA]/80 backdrop-blur-md py-4 lg:py-6 z-30 gap-4">
                <div className="flex items-center gap-4 lg:gap-6">
                    ...
                    <div>
                        <h1 className="text-xl lg:text-2xl font-black text-zinc-900 tracking-tight">Edit Experience</h1>
                            ...
                            <section className="bg-white rounded-[1.5rem] lg:rounded-[2.5rem] p-6 lg:p-10 border border-zinc-100 shadow-sm space-y-6 lg:space-y-8">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-zinc-50 border-none rounded-xl lg:rounded-2xl py-4 lg:py-5 px-6 lg:px-8 text-xs lg:text-sm font-bold text-zinc-900 focus:ring-2 focus:ring-amber/10 transition-all cursor-pointer"
                                    >
