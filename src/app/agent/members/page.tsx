    ...
    return (
        <div className="space-y-10">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-heading-lg font-medium text-zinc-900 tracking-tight mb-2">Elite Members</h1>
            ...
            <div className="grid grid-cols-3 gap-6">
                <div className="bg-zinc-900 rounded-[2rem] p-8 text-white flex items-center justify-between relative overflow-hidden">
                    <div className="relative z-10">
                        <p className="text-caption font-medium text-white/40 uppercase tracking-widest mb-1">Total Member Equity</p>
                        <h3 className="text-heading-md font-medium">₦120,482,000</h3>
                    </div>
                ...
                <div className="bg-white rounded-[2rem] p-8 border border-zinc-100 flex items-center justify-between shadow-sm">
                    <div>
                        <p className="text-caption font-medium text-zinc-400 uppercase tracking-widest mb-1">New Members (Month)</p>
                        <h3 className="text-heading-md font-medium text-zinc-900">142</h3>
                    </div>
                ...
                <div className="bg-white rounded-[2rem] p-8 border border-zinc-100 flex items-center justify-between shadow-sm">
                    <div>
                        <p className="text-caption font-medium text-zinc-400 uppercase tracking-widest mb-1">Elite Tier Retention</p>
                        <h3 className="text-heading-md font-medium text-zinc-900">98.4%</h3>
                    </div>
                    <div className="w-12 h-12 rounded-xl bg-zinc-50 flex items-center justify-center text-zinc-400">
                        <Shield size={24} />
                    </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-zinc-50/50">
                                <th className="px-10 py-6 text-caption font-medium text-zinc-400 uppercase tracking-widest">Member ID</th>
                                <th className="px-10 py-6 text-caption font-medium text-zinc-400 uppercase tracking-widest">Name</th>
                                <th className="px-10 py-6 text-caption font-medium text-zinc-400 uppercase tracking-widest">Tier</th>
                                <th className="px-10 py-6 text-caption font-medium text-zinc-400 uppercase tracking-widest">Spent</th>
                                <th className="px-10 py-6 text-caption font-medium text-zinc-400 uppercase tracking-widest">Last Flight</th>
                        ...
                        <tbody className="divide-y divide-zinc-50">
                            {members.map((member, i) => (
                                <tr key={member.id} className="hover:bg-zinc-50/50 transition-colors group">
                                    <td className="px-10 py-6 text-caption font-medium text-zinc-400 tracking-tighter">{member.id}</td>
                                    <td className="px-10 py-6">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-body font-medium text-zinc-900 leading-none mb-1">{member.name}</p>
                                                <p className="text-caption font-medium text-zinc-400 italic">Member since {member.since}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-10 py-6">
                                        <span className={`text-caption font-medium px-3 py-1 rounded-lg border ${member.tier === 'VIP' ? 'bg-zinc-900 text-white border-zinc-900' :
                                    ...
                                    <td className="px-10 py-6 text-body font-medium text-zinc-900">{member.spent}</td>
                                    <td className="px-10 py-6 text-body-sm font-medium text-zinc-400">{member.lastFlight}</td>
                                    <td className="px-10 py-6 text-body-sm font-medium">
                                        <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-caption font-medium uppercase tracking-widest ${member.status === 'Active' ? 'bg-emerald-50 text-emerald-500' : 'bg-zinc-100 text-zinc-400'
                                            }`}>
